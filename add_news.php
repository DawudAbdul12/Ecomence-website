...
if(isset($_POST['submit'])){
   $errors = array();
	...
	$product_image = $_FILES['picx']['name'];
  ...
  $query ="INSERT INTO blog_tb(pic,title,date,content,tag,posted_by,published,source)
		           VALUES ('img/{$name2}','{$title}','{$date}','{$description}','{$tag}','{$publish_by}','{$publish}','{$source}')";
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <div class="dropdown pull-right">
                        			   ...
                        			   <div class="text-left">
                    <h4 class="text-uppercase font-bold m-b-0">ADD NEWS </h4>
				...
				<br/>
									...
									<?php if(empty($edit_news)){?>
									
                                            <form class="form-horizontal group-border-dashed" action="add_news.php" method="POST" enctype="multipart/form-data">
                                              
											  <h5 class="m-t-30"><b>Title</b></h5>
											   <div class="form-group ">
							           <div class="col-xs-12">
								      <input class="form-control" type="text" required=""  Name="title" placeholder="Add news Heading">
							             </div>
						                        </div>
		

									  <h5 class="m-t-30"><b>Source</b></h5>
									    <div class="form-group ">
							           <div class="col-xs-12">
								      <input class="form-control" type="text"  Name="source" placeholder="Add news Source">
							             </div>
						                        </div>
                                    ...
                                    <p class="text-muted m-b-20 font-13">
                                       Description Goes Here
                                        ...
                                        <?php }else{?>
										 ...
										 <form class="form-horizontal group-border-dashed" action="add_news.php?edit_news=<?php echo $edit_news;?>" method="POST" enctype="multipart/form-data">
                                              <?php
								
							   $tb_select = "SELECT * FROM blog_tb WHERE ID = {$edit_news} ";
							    ...
							    $date = $row['date'];
											...
											?>
											  <h5 class="m-t-30"><b>Title</b></h5>
											   <div class="form-group ">
							           <div class="col-xs-12">
								      <input class="form-control" type="text" required=""  value="<?php echo $title; ?>" Name="title" placeholder="Add news Heading">
							             </div>
						                        </div>
									  ...
									  <h5 class="m-t-30"><b>Source</b></h5>
											   <div class="form-group ">
							           <div class="col-xs-12">
								      <input class="form-control" type="text"  value="<?php echo $source; ?>" Name="source" placeholder="Add news Source">
							             </div>
						                        </div>
