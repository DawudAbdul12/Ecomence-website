...
// This first query is just to get the total count of 
							    ...
							    $published = "Yes";
								$tb_select = "SELECT COUNT(id) FROM blog_tb WHERE published = '{$published}' ";
...
if($last != 1){
	...
	if ($pagenum > 1) {
        $previous = $pagenum - 1;
		$paginationCtrls .= '<a href="'.$_SERVER['PHP_SELF'].'?pn='.$previous.'"><i class="fa fa-chevron-left"></i> PREVIOUS </a> &nbsp &nbsp &nbsp';
		...
		<div class="container">
			...
			<div class="row blog">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bot">
					...
					?></h3>
					<p class="small"><span style="text-transform: uppercase;">
					...
					echo "Source : ".$row['source']." | ";
					 ...
					 <?php  echo date('M d Y',strtotime($row['date'])); ?></span>
					 </p>
