...
<?php	
  ...
  /*********************************************************************************************/
							...
							$id = mysqli_real_escape_string($connect,$_GET['del_news']);
							$query = "DELETE FROM blog_tb WHERE id = {$id} LIMIT 1";
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                                	    ...
                                                	    <?php
							   $tb_select = "SELECT * FROM blog_tb  order by id desc  ";
							   ...
							   while($row = mysqli_fetch_array($result)){
                                    ...
                                    <tr>
										...
										<td><?php echo "<a href=\"add_news.php?edit_news=".urlencode($row['0'])."\">Read</a> |  <a href=\"blog_tb.php?del_news=".urlencode($row['0'])."\" onClick =\"return confirm('Are you sure You want to Delete')\">Delete</a>";?></td>
                                    </tr>
									<?php }   ?>
                                        </tbody>
                                    </table>
