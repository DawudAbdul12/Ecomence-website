...
<?php	
  ...
  /*********************************************************************************************/
							...
							$id = mysqli_real_escape_string($connect,$_GET['del_gallery']);
							$query = "DELETE FROM gallery_tb WHERE id = {$id} LIMIT 1";
							$result = mysqli_query($connect,$query);
							
							$query_image = "DELETE FROM photos_tb WHERE gallery_id = {$id} LIMIT 1";
							$result_image = mysqli_query($connect,$query_image);
							
							if(mysqli_affected_rows($connect) >=1){
							echo "<script> window.location.replace('gallery_tb.php') </script>";
							}else{
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                                	    ...
                                                	    <?php
							   $tb_select = "SELECT * FROM gallery_tb order by id desc  ";
							   ...
							   while($row = mysqli_fetch_array($result)){
                                    ...
                                    <tr>
										...
										<td><img src="<?php echo $row['4'];?>" width="50px" height="50px"></td>
										<td><?php echo $row['1'];?> </td>
										<td><?php echo $row['2'];?></td>
										<td><?php echo $row['3'];?></td>
										<td><?php echo $row['6'];?></td>
										<td><?php echo "<a href=\"add_photos.php?edit_gallery=".urlencode($row['0'])."\">Read</a> |  <a href=\"gallery_tb.php?del_gallery=".urlencode($row['0'])."\" onClick =\"return confirm('Are you sure You want to Delete')\">Delete</a>";?></td>
                                    </tr>
									<?php }   ?>
                                        </tbody>
                                    </table>
