...
if(isset($_POST['submit'])){
   ...
   $result_set = mysqli_query($connect,$query);
	...
	if(empty($name2)){
	  $image = "";
	$query ="INSERT INTO brand_tb(name,description,date,image)
		           VALUES ('{$name}','{$desc}','{$date}','{$image}')";
  ...
  $query ="INSERT INTO brand_tb(name,description,date,image)
		           VALUES ('{$name}','{$desc}','{$date}','img/{$name2}')";
  $check = mysqli_query($connect,$query);
   if($check){
   $message = "<strong><span class=\"label label-success\">Please You Have Successfully Added New Record </span></strong>".mysqli_error($connect);
...
/*********************************************************************************************/
  ...
  /*********************************************************************************************/
							...
							$id = mysqli_real_escape_string($connect,$_GET['del_brand']);
							$query = "DELETE FROM brand_tb WHERE ID = {$id} LIMIT 1";
							$result = mysqli_query($connect,$query);
							if(mysqli_affected_rows($connect) == 1){
							
							echo "<script> window.location.replace('brand.php') </script>";
							}else{
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <h4 class="text-uppercase font-bold m-b-0">Add New Brand for Category </h4>
				...
				<br/>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
									<?php if(empty($edit_brand)){?>
                                            <form class="form-horizontal group-border-dashed" action="brand.php" method="POST" enctype="multipart/form-data">
                                              
					         <input type ="hidden"  value="<?php echo date("d-M-Y") ; ?>" name="date"/> 

						  <p class="text font-14 m-b-30">Brand Name *</p>
                         <div class="form-group ">
						
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Brand Name" name="name">
                            </div>
                        </div>
						                      <p class="text font-14 m-b-30">Image</p>
	                                          <div class="form-group">
						 ...
						 <form class="form-horizontal group-border-dashed" action="brand.php?edit_brand=<?php echo $edit_brand;?>"  method="POST" enctype="multipart/form-data">		
								<?php
								
							   $tb_select = "SELECT * FROM brand_tb WHERE ID = {$edit_brand} ";
                         ...
                         <div class="form-group ">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Brand Name" name="name" value="<?php echo $row['name'];?>">
                            </div>
                        </div>
						                      <p class="text font-14 m-b-30">Image</p>
	                                          <div class="form-group">
												...
												<img src="<?php echo $row['4'];?>" width="30px" height="30px">
                                         <p class="text font-14 m-b-30">Description</p>
                                      <div class="form-group">
					...
					<div class="col-sm-8">
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                                	    ...
                                                	    <?php
							   $tb_select = "SELECT * FROM brand_tb order by ID desc  ";
							   $result = mysqli_query($connect,$tb_select);
							   if(!$result){
							   die ("SELECT TABLE FAILED".mysqli_error());
							   }
							   while($row = mysqli_fetch_array($result)){
                                    ...
                                    <tr>
										...
										<td><img src="<?php echo $row['4'];?>" width="30px" height="30px"> </td>

										<td><?php echo "<a href=\"brand.php?edit_brand=".urlencode($row['0'])."\">Read</a> |  <a href=\"brand.php?del_brand=".urlencode($row['0'])."\" onClick =\"return confirm('Are you sure You want to Delete')\">Delete</a>";?></td>
                                    </tr>
