...
<head>
    ...
    <style type="text/css">
        body {font-family:'Raleway',sans-serif;background: #e7e7e7;}
...
<body>     
    ...
    <div class="container forms">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="pull-right">
                    <h5><strong>Order Date: </strong><?php echo $order_date;?></h5>
                    <h5><strong>Order Status:</strong> <span><?php echo $order_status ?></span></h5>
                    <h5><strong>Order ID:</strong> #<?php echo $order_id;?></h5>
                </div> 
            </div>
        </div>
        <div class="row">
                    ...
                    <tbody>
					 ...
					 <?php 
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo $row_product['image']; ?>" width="50px" height="50px" class="img-responsive"></td>
        ...
        <div class="row next-sec">
        	...
        	<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 align-right">
        		<h4><strong>Total Quantity:</strong>  <?php echo $total_quantity;?> items</h4>
        		<h4><strong>Sub-total:</strong> <?php 
        		...
        		<hr>
        		<h3><strong>GHC <?php echo $total_amount;?></strong></h3>
        	</div>
        </div>    
    </div>
