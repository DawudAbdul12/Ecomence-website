...
<?php require_once("includes/function.php");?>
							...
							<?php
											 ...
											 //  $product_id =  $_SESSION['product_id'];
											   if(isset($attri_id)){
												$tb_select = "SELECT COUNT(id) FROM product_tb WHERE publish = '{$status}' AND category = {$category_id} AND attribute = {$attri_id} ";
												}elseif(isset($brnd_id)){
												$tb_select = "SELECT COUNT(id) FROM product_tb WHERE publish = '{$status}' AND category = {$category_id} AND brand = {$brnd_id} ";
												}else{
												$tb_select = "SELECT COUNT(id) FROM product_tb WHERE publish = '{$status}' AND category = {$category_id} ";
												}
                ...
                <div id="cart-icon">
                    ...
                    <div class="cart-quckView">
						...
						<div id="mycart"></div>
			                 ...
			                 <?php 
							 ########### SELECT MENU FOR SUB CATEGORY #############
							 
	                           $tb_select = "SELECT * FROM category_tb WHERE ID = {$category_id}";
							   $result = mysqli_query($connect,$tb_select);
							   if(!$result){
							   ...
							   $nav_id = $row_c['0'];
                                    ...
                                    <div class="innerContent">
                                        ...
                                        <div class="filterBox">
										   ...
										   $tb_select_cat_attribute_tb = "SELECT * FROM category_attribute_tb WHERE category = {$category_id} ORDER BY ID DESC " ;
										   ...
										   $tb_select_attr_tb = "SELECT * FROM attribute_tb WHERE id = {$attr_id} ORDER BY id DESC " ;
                                    ...
                                    ?>
                                        ...
                                        <div class="filterBox">
                                            ...
                                            <ul>
											 ...
											 <?php
									//  STATEMENT FOR FEATURED PRODUCT 
										   $tb_select_cat_brand_tb = "SELECT * FROM category_brand_tb WHERE category = {$category_id} ORDER BY id DESC " ;
										   ...
										   $tb_select_brand_tb = "SELECT * FROM brand_tb WHERE ID = {$cat_id} ORDER BY id DESC " ;
                           ...
                           <div class="col-md-8">
                            ...
                            <div class="row products">
							  ...
							  <?php
							   ...
							   if(isset($attri_id)){
							    $tb_select_list = "SELECT * FROM product_tb  WHERE category = {$category_id} AND attribute = {$attri_id} ORDER by id DESC {$limit} ";
	               
							   }elseif(isset($brnd_id)){
							      $tb_select_list = "SELECT * FROM product_tb  WHERE category = {$category_id} AND brand = {$brnd_id} ORDER by id DESC {$limit} ";
							   }else{
							   
							   $tb_select_list = "SELECT * FROM product_tb  WHERE category = {$category_id} ORDER by id DESC {$limit} ";
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="actions">
                                                <ul class="add-to-links">
                                                    ...
                                                    <li id="<?php echo $row_list['ID'];?>success_message" ><a title="" onclick="cart('<?php echo $row_list['ID']; ?>')" ><i class="fa fa-shopping-cart"></i><span>Cart</span></a></li>
