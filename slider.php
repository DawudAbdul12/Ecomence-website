...
if(isset($_POST['submit'])){
  ...
  $query ="INSERT INTO slider_tb(name,description,date,image)
...
/*********************************************************************************************/
  ...
  /*********************************************************************************************/
							...
							$id = mysqli_real_escape_string($connect,$_GET['del_slide']);
							$query = "DELETE FROM slider_tb WHERE ID = {$id} LIMIT 1";
							$result = mysqli_query($connect,$query);
							if(mysqli_affected_rows($connect) == 1){
							
							echo "<script> window.location.replace('slider.php') </script>";
							}else{
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <h4 class="text-uppercase font-bold m-b-0">Add New Slider </h4>
					<p class="text font-14 m-b-30">Add slide image to Home </p>
				...
				<br/>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
									<?php if(empty($edit_slide)){?>
                                            <form class="form-horizontal group-border-dashed" action="slider.php" method="POST" enctype="multipart/form-data">
                                              
					         <input type ="hidden"  value="<?php echo date("Y=m-d") ; ?>" name="date"/> 

						  <p class="text font-14 m-b-30">Slide Name *</p>
                         <div class="form-group ">
						
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Slide Name" name="name">
                            </div>
                        </div>
						 ...
						 <form class="form-horizontal group-border-dashed" action="slider.php?edit_slide=<?php echo $edit_slide;?>"  method="POST" enctype="multipart/form-data">		
								<?php
								
							   $tb_select = "SELECT * FROM slider_tb WHERE ID = {$edit_slide} ";
                         ...
                         <div class="form-group ">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Slide Name" name="name" value="<?php echo $row['name'];?>">
                            </div>
                        </div>
						                      <p class="text font-14 m-b-30">Image</p>
	                                          <div class="form-group">
												...
												<img src="<?php echo $row['2'];?>" width="30px" height="30px">
                                         <p class="text font-14 m-b-30">Description</p>
                                      <div class="form-group">
					...
					<div class="col-sm-8">
							   ...
							   while($row = mysqli_fetch_array($result)){
                                    ...
                                    <tr>
										...
										<td><img src="<?php echo $row['2'];?>" width="30px" height="30px"> </td>

										<td><?php echo "<a href=\"slider.php?edit_slide=".urlencode($row['0'])."\">Read</a> |  <a href=\"slider.php?del_slide=".urlencode($row['0'])."\" onClick =\"return confirm('Are you sure You want to Delete')\">Delete</a>";?></td>
                                    </tr>
