...
if(isset($_POST['submit'])){
	...
	$product_image = $_FILES['pix']['name'];
	 
	 // CHECK IMAGE 
	 if(empty($product_image)){
	 $message = "<strong ><span class=\"label label-danger\"> Please Upload image for the Gallery </span></strong>".mysqli_error($connect);
	 $errors =$message;
	 }
     // CHECK AND SEE WHETHER PRODUCT EXIST OF NOT
	 $query="SELECT *  ";
	 $query.=" FROM gallery_tb  ";
  ...
  $query ="INSERT INTO gallery_tb(title,date,tag,published,description,image)
		  VALUES ('{$title}','{$date}','{$tag}','{$publish}','{$description}','img/{$name2}')";
  $pagess = mysqli_query($connect,$query);
   ...
   // GET PRODUCT ID
      $query="SELECT *  ";
	 $query.=" FROM gallery_tb ";
	 $query.=" WHERE title = '{$title}' and date = '{$date}' order by id desc limit 1 ";
   ...
   $result_set = mysqli_query($connect,$query);
    ...
    if(mysqli_num_rows($result_set) >= 1){
	 ...
	 // GET PRODUCT ID
	   $gallery_data = mysqli_fetch_array($result_set);
	   ...
	   foreach($_FILES['picx']['name'] as $key => $val){
		...
		if(move_uploaded_file($t_name,$dir."/".$name)){
          $query_image="INSERT INTO photos_tb(gallery_id,image)
		         VALUES ('{$gallery_id}','img/{$name}')";
 ...
 $("#imageupload").on('change', function () {
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <div class="dropdown pull-right">
                        			   ...
                        			   <div class="text-left">
                    <h4 class="text-uppercase font-bold m-b-0">ADD NEW GALLERY </h4>
          ...
          <form class="form-horizontal group-border-dashed" action="add_photos.php" method="POST" enctype="multipart/form-data">
                                              
											  <h5 class="m-t-30"><b>Gallery Title</b></h5>
											   <div class="form-group ">
							           <div class="col-xs-12">
								      <input class="form-control" type="text" required=""  Name="title" placeholder="Gallery Title">
							             </div>
						                        </div>
		                            <div class="form-group">
												<div class="col-sm-12">
								 ...
								 <h5><b>Input Tags</b></h5>
                                    ...
                                    <div class="tags-default">
                                        <input type="text"  data-role="tagsinput" placeholder="add tags" name="tag"/>
								           ...
								           <h4 class="m-t-30"><b>Add Gallery Banner Image</b></h4>  
								 ...
								 <h4 class="m-t-30"><b>Add Gallery Picture(s)</b></h4>  
                                        ...
                                        <div class="col-lg-8">
                                          <h5><b>Gallery Short Description</b></h5>
                                    <p class="text-muted m-b-20 font-13">
							...
							<form class="form-horizontal group-border-dashed" action="add_photos.php?edit_gallery=<?php echo $edit_gallery;?>" method="POST" enctype="multipart/form-data">
                                        	<?php
								
							   $tb_select = "SELECT * FROM gallery_tb WHERE id = {$edit_gallery} ";
							   ...
							   while($row = mysqli_fetch_array($result)){
											?>
											  ...
											  <h5 class="m-t-30"><b>Gallery Title</b></h5>
											   <div class="form-group ">
							           <div class="col-xs-12">
								      <input class="form-control" type="text" required=""  value ="<?php echo $row['title'];?>" Name="title" placeholder="Gallery Title">
							             </div>
						                        </div>
								 ...
								 <h5><b>Input Tags</b></h5>
								  ...
								  <h4 class="m-t-30"><b>Add Gallery Banner Image</b></h4>  
											<div class="file-box m-l-15">
											  	<div id="preview-image_banner"><img src="<?php echo $row['image'];?>" alt="image"  class="img-responsive img-thumbnail" /></div>
                                                <div class="fileupload add-new-plus">
                                                    <span><i class="zmdi-plus zmdi"></i></span>
                                                    <input id="imageupload_banner" type="file" name="pix"  class="upload">
                                                </div>
								 ...
								 <div class="form-group">
                                   <div class="col-sm-12">
                                         <select class="form-control select2" name="publish">
                                       <option <?php if($row['published'] == "Yes"){echo "selected";} ?> value="Yes">Yes</option>
									    <option <?php if($row['published'] == "No"){echo "selected";} ?> value="No">No</option>
										 
                                    </select>
                                   </div>               
                                 </div>	
								<h4 class="m-t-30"><b>Add Art Gallery</b></h4>  
							   ...
							   $product_image_id = "";
	                           $tb_select_image = "SELECT * FROM photos_tb WHERE gallery_id = {$edit_gallery} ORDER by id ASC ";
									...
									?>
											...
											<div class="form-group">
                                                    <div class="col-sm-offset-9 col-sm-9 m-t-15">
                                                        ...
                                                        <button type="submit" class="btn btn-default waves-effect m-l-5" >
                                                            Reset
                                                        </button>
