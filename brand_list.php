...
<?php require_once("includes/function.php");?>
								   ...
								   <?php
									  ######### GET CATEGORY ID FROM THE LINK ########
									   if(isset($_GET['brand'])){
									   $brand_id = preg_replace('#[^0-9]#', '', $_GET['brand']);
												}
							...
							<?php
											 ...
											 //  $product_id =  $_SESSION['product_id'];
												$tb_select = "SELECT COUNT(id) FROM product_tb WHERE publish = '{$status}' AND brand = {$brand_id} ";
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="sideBar">
                                <div class="comapre-product sideBox">
								 <?php
						       $tb_select_cat = "SELECT * FROM brand_tb WHERE id = {$brand_id} LIMIT 1";
                                         ...
                                         <div class="filterBox">
											...
											<?php 
											  ...
											  $tb_select = "SELECT * FROM brand_tb ORDER BY ID DESC";
											   ...
											   while($row_cat = mysqli_fetch_array($result)){
											   //$parent_id = $row_cat['0'];
											   if($row_cat['0'] == $brand_id){
											   $title = $row_cat['1'];
											?>
											<li><a href="brand_list.php?brand=<?php echo $row_cat['0']; ?>"><strong><?php echo $row_cat['1'];?><span></span></strong></a></li>
											<?php }else{ ?>
											<li><a href="brand_list.php?brand=<?php echo $row_cat['0']; ?>"><?php echo $row_cat['1'];?><span></span></a></li>
											<?php 
                           ...
                           <div class="col-md-8">
                            ...
                            <div class="row products">
							  ...
							  <?php
							   ...
							   $tb_select_list = "SELECT * FROM product_tb  WHERE brand = {$brand_id} AND publish = '{$status}' ORDER by id DESC {$limit} ";
