                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                                	    ...
                                                	    <?php
							   $tb_select = "SELECT * FROM product_tb  order by id desc  ";
							   ...
							   while($row = mysqli_fetch_array($result)){
                                    ...
                                    <tr>
										...
										<td><img src="<?php echo $row['14'];?>" width="30px" height="30px"> </td>
										...
										<td><?php echo "<a href=\"product_frm.php?edit_product=".urlencode($row['0'])."\">Read</a> |  <a href=\"product_tb.php?del_product=".urlencode($row['0'])."\" onClick =\"return confirm('Are you sure You want to Delete')\">Delete</a>";?></td>
                                    </tr>
									<?php }   ?>
                                        </tbody>
                                    </table>
