...
if(isset($_POST['submit'])){
  ...
  $pagess = mysqli_query($connect,$query);
   if($pagess){
   $message = "<strong style=\"color:#F00; padding:20px 20px 0px 0px;\">Please You Have Successfully Updated your Profile </strong>".mysqli_error($connect);
 // header("LOCATION:dashboard.php");
  ...
  $result = mysqli_query($connect,$query);
		...
		//header("LOCATION:staffarea.php");
		 $message = "<strong style=\"color:#0f0; padding:20px 20px 0px 0px;\">updated succefully </strong>".mysqli_error($connect);
		}else{
	 echo "upload failed!".mysqli_error($connect);
	  $message = "<strong style=\"color:#F00; padding:20px 20px 0px 0px;\"> upload failed!</strong>".mysqli_error($connect);
	}
        ...
        <div id="wrapper">
          ...
          <div class="wrapper-page">
            <div class="text-center">
                <a href="index-2.html" class="logo"><span> Admin Dashboard<span></span></span></a>
               
            </div>
        	<div class="m-t-40 card-box">
                <div class="text-center">
                    <h4 class="text-uppercase font-bold m-b-0">Edit User Info</h4>
                ...
                <div class="panel-body">
                    <form class="form-horizontal m-t-20" action="change_pass.php?page=<?php echo $edit_password; ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group ">
							<div class="col-xs-12">
                             ...
                             parsley-type="email" placeholder="Enter a valid e-mail" name="small_img"/>
							</div>
						</div>
